...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TikiTestRefactor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16TikiTestRefactor11AppDelegate")
...
SWIFT_CLASS("_TtC16TikiTestRefactor20CommentTableViewCell")
...
SWIFT_CLASS("_TtC16TikiTestRefactor14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(TikiTestRefactor)) <UITableViewDataSource>
...
@interface ViewController (SWIFT_EXTENSION(TikiTestRefactor)) <UISearchBarDelegate>
